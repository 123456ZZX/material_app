(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (global = global || self, factory(global.FocusOutside = {}));
  ...
  var Map = (function() {
    ...
    Map.prototype.values = function() {
      return this.maps.map(function(item) { return item[1]; });
    };
  ...
  function focusinHandler(event) {
    ...
    if (!node) {return;}
    var _a = findNodeMap(elMap.entries(), node) || {}, item = _a.item, nodeList = _a.nodeList;
    if (!item) {return;}
  ...
  function findNodeMap(entries, node) {
    for (var i = 0; i < entries.length; i++) {
      var _a = entries[i], key = _a[0], nodeList = _a[1];
      var item = nodeList.find(function(item) { return item.node === node; });
      if (item) {return { key: key, item: item, nodeList: nodeList };}
    }
  }
  ...
  function unbind(el) {
    var _a = findNodeMap(elMap.entries(), el) || {}, item = _a.item, key = _a.key, nodeList = _a.nodeList;
    if (!item) {return;}
    var node = item.node, callback = item.callback, oldTabIndex = item.oldTabIndex;

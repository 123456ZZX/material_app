...
export declare class FksMessageBoxComponent extends Vue {
  title: string
  message: string
  type: MessageType
  iconClass: string
...
export interface FksMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: FksMessageBoxComponent) => void

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: FksMessageBoxComponent, done: (() => void)) => void
...
export interface FksMessageBoxShortcutMethod {
  (message: string, title: string, options?: FksMessageBoxOptions): Promise<MessageBoxData>
  (message: string, options?: FksMessageBoxOptions): Promise<MessageBoxData>
}

export interface FksMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: FksMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: FksMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: FksMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: FksMessageBoxShortcutMethod

  /** Set default options of message boxes */
  setDefaults (defaults: FksMessageBoxOptions): void

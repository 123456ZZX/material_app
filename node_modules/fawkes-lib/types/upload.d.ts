import { FawkesLibComponent } from './component'
...
export interface FksUploadInternalRawFile extends File {
  uid: number
}

export interface FksUploadInternalFileDetail {
  status: FileUploadStatus,
  name: string,
  size: number,
  percentage: number,
  uid: number,
  raw: FksUploadInternalRawFile,
  url?: string
}

export interface FksUploadProgressEvent extends ProgressEvent {
  percent: number
}
...
export interface HttpRequestOptions {
  ...
  filename: string,
  action: string,
  onProgress: (e: FksUploadProgressEvent) => void,
  onSuccess: (response: any) => void,
  onError: (err: ErrorEvent) => void
}

/** Upload Component */
export declare class FksUpload extends FawkesLibComponent {
  ...
  onPreview: (file: FksUploadInternalFileDetail) => void

  /** Hook function when files are removed */
  onRemove: (file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void

  /** Hook function when uploaded successfully */
  onSuccess: (response: any, file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void

  /** Hook function when some errors occurs */
  onError: (err: ErrorEvent, file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void

  /** Hook function when some progress occurs */
  onProgress: (event: FksUploadProgressEvent, file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void

  /** Hook function when file status change */
  onChange: (file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void
  ...
  beforeUpload: (file: FksUploadInternalRawFile) => boolean | Promise<File | Blob | boolean>
  ...
  onExceed: (file: FksUploadInternalFileDetail, fileList: FksUploadInternalFileDetail[]) => void

  /** Clear the upload file list */
  clearFiles(): void

  /** Abort specified file */
  abort(file: FksUploadInternalFileDetail): void

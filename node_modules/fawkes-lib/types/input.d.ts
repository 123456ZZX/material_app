import { FawkesLibComponent, FawkesLibComponentSize } from './component'

/** The resizability of fks-input component */
export type Resizability = 'none' | 'both' | 'horizontal' | 'vertical'
export type InputType = 'text' | 'textarea'

/** Controls how fks-input component automatically sets size */
...
/** Input Component */
export declare class FksInput extends FawkesLibComponent {
  /** Type of input */
  type: InputType

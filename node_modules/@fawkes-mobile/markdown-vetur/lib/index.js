...
async function parseAndWrite(options) {
    ...
    const datas = mds
        .map(md => (0, formatter_1.formatter)((0, parser_1.mdParser)(md), options.tagPrefix))
        .filter(item => !!item);
    const webTypes = (0, web_types_1.genWebTypes)(datas, options);
    const veturTags = (0, vetur_1.genVeturTags)(datas);
    const veturAttributes = (0, vetur_1.genVeturAttributes)(datas);

...
var _default = createComponent({
  ...
  methods: {
    ...
    toggle: function toggle(towards) {
      ...
      if (computedRightWidth && towards === 'right' && offset > computedRightWidth * threshold) {
        this.open('right');
      } else if (computedLeftWidth && towards === 'left' && offset > computedLeftWidth * threshold) {
        this.open('left');
      } else {
        this.close();
      }

...
var _default = createComponent({
  ...
  methods: {
    ...
    toggleClickable: function toggleClickable() {
      var clickable = this.visible && this.forbidClick;
    ...
    genIcon: function genIcon() {
      ...
      var defaultIcon = IOCN_CONFIGS[type];
      var hasIcon = icon || defaultIcon;
      if (hasIcon) {
        return h(_icon.default, {
          "class": [bem('icon'), "fm-icon fm-icon-" + (icon || defaultIcon)],
          "attrs": {
            "name": icon || type
          }
        });
  ...
  render: function render() {
    ...
    return h("transition", {
      ...
      "class": [bem([this.position, (_ref = {}, _ref[this.type] = !this.icon, _ref)]), this.customClass],
      "on": {
        "click": this.onClick
      }

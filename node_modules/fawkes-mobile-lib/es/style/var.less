...
@green: #40bb5a;
@default: #4091ff;
@default-border-color: rgba(64, 158, 255, 0.32);

// Gradient Colors
@gradient-red: linear-gradient(to right, #ff6034, #ff4b4b);
...
@action-sheet-description-color: @gray-5;
...
@button-default-border-color: @default-border-color;
...
@button-link-background-color: @blue-link;
@button-link-border-color: @blue-link;
@button-info-color: @white;
@button-info-background-color: @gray-7;
@button-info-border-color: @gray-7;
...
@calendar-range-middle-color: @blue;
...
@dialog-message-font-size: @font-size-base;
...
@dialog-cancel-button-text-color: @black;
...
@notify-error-background-color: @red;
@notify-warning-background-color: @orange;
@notify-info-background-color: @gray-6;
...
@picker-action-font-size: @font-size-base;
...
@push-refresh-foot-height: 50px;
@push-refresh-foot-font-size: @font-size-md;
@push-refresh-foot-text-color: @gray-6;
...
// Search
@search-padding: 10px @padding-md;
@search-background-color: @white;
@search-content-background-color: @gray-1;
@search-input-height: 34px;
@search-field-font-size: @font-size-base;
@search-label-padding: 0 5px;
@search-label-color: @text-color;
@search-label-font-size: @font-size-sm;
@search-left-icon-color: @gray-6;
@search-action-padding: 0 @padding-xs;
@search-action-text-color: @text-color;
@search-action-font-size: @font-size-sm;
...
@sidebar-padding: 16px @padding-sm;
...
@slider-button-width: 16px;
@slider-button-height: 16px;
...
@uploader-delete-background-color: rgba(51, 51, 51, 0.4);

...
var _default2 = createComponent({
  ...
  methods: {
    ...
    genPreviewItem: function genPreviewItem(item, index) {
      ...
      var listAble = (_item$listable = item.listable) != null ? _item$listable : this.listable;
      ...
      var DeleteImgIcon = showDelete && h("div", {
        "class": bem('fileList-delete'),
        "on": {
          "click": function click(event) {
            event.stopPropagation();
            _this6.onDelete(item, index);
        ...
        "class": bem('fileList-delete-icon')
      })]);
      ...
      return listAble ? h("div", {
        ...
        "class": bem('list-name')
      }, [item.fileName ? item.fileName : item.file.name]), h("span", [item.fileSize ? item.fileSize : item.file.size, "kb"])])]), DeleteImgIcon]) : h("div", {
        "class": bem('preview'),
        "on": {
          "click": function click() {
            _this6.$emit('click-preview', item, _this6.getDetail(index));
  ...
  render: function render() {
    var h = arguments[0];
    var PreviewList = this.slots('preview-list', this.fileList);
    return this.listable ? h("div", {
      "class": [bem('list-wrapper', {
        disabled: this.disabled
      })]
    }, [this.genPreviewList(), this.genUpload()]) : PreviewList ? h("div", {
      "class": [bem(), 'custom-preview-list']
    }, [PreviewList, this.genUpload()]) : h("div", {
      "class": bem()
    }, [h("div", {
      "class": bem('wrapper', {
        disabled: this.disabled

...
var _popperjs = require("@fawkes-mobile/popperjs");
  ...
  methods: {
    ...
    renderAction: function renderAction(action, index) {
      ...
      return h("div", {
        ...
        "class": ["fm-icon fm-icon-" + icon, bem('action-icon')]
      }), h("div", {
  ...
  render: function render() {
    ...
    return h("span", {
      ...
      "attrs": {
        ...
        "customClass": this.popperClass,
        "modal": this.modal,
        "position": null,
        "transition": "fm-popover-zoom",
        "lockScroll": false,

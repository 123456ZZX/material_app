...
var _default = createComponent({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(this.adjustSize);
    if (this.fmForm) {
      this.fmForm.addField(this);
    }
  },
  beforeDestroy: function beforeDestroy() {
    if (this.fmForm) {
      this.fmForm.removeField(this);
    }
  },
  computed: {
    ...
    showError: function showError() {
      ...
      if (this.fmForm && this.fmForm.showError && this.validateFailed) {
        return true;
      }
    },
  ...
  methods: {
    ...
    validateWithTrigger: function validateWithTrigger(trigger) {
      if (this.fmForm && this.rules) {
        var defaultTrigger = this.fmForm.validateTrigger === trigger;
    ...
    updateValue: function updateValue(value, trigger) {
      ...
      value = (0, _utils.isDef)(value) ? String(value) : '';
      ...
      if (this.type === 'number' || this.type === 'digit' || this.type === 'tel') {
    ...
    onClickLeftIcon: function onClickLeftIcon(event) {
      this.$emit('click-prefix-icon', event);
    },
    onClickRightIcon: function onClickRightIcon(event) {
      this.$emit('click-suffix-icon', event);
    },
    ...
    genLeftIcon: function genLeftIcon() {
      var h = this.$createElement;
      var showLeftIcon = this.slots('prefix-icon') || this.prefixIcon;
      if (showLeftIcon) {
        return h("div", {
        ...
        }, [this.slots('prefix-icon') || h("i", {
          "class": "fm-icon fm-icon-" + this.prefixIcon
        })]);
      }
    },
    genRightIcon: function genRightIcon() {
      ...
      var showRightIcon = slots('suffix-icon') || this.suffixIcon;
      if (showRightIcon) {
        return h("div", {
        ...
        }, [slots('suffix-icon') || h("i", {
          "class": "fm-icon fm-icon-" + this.suffixIcon
        })]);
      }
    },
    ...
    genMessage: function genMessage() {
      var h = this.$createElement;
      if (this.fmForm && this.fmForm.showErrorMessage === false) {
        return;
      }
    ...
    getProp: function getProp(key) {
      ...
      if (this.fmForm && (0, _utils.isDef)(this.fmForm[key])) {
        return this.fmForm[key];
      }
    },
  ...
  render: function render() {
    ...
    return h(_cell.default, {
      ...
      "class": bem('body')
    }, [slots('left-tag') && h("div", {
      "class": bem('left-tag')
    }, [slots('left-tag')]), this.genInput(), this.showClear && h("i", {
      "class": ['fm-icon fm-icon-clear', bem('clear')],
      "on": {
        "touchstart": this.onClear
      }
    }), this.genRightIcon(), slots('right-tag') && h("div", {
      "class": bem('right-tag')
    }, [slots('right-tag')]), slots('button') && h("div", {
      "class": bem('button')

...
var _default2 = createComponent({
  ...
  mounted: function mounted() {
    ...
    if (this.fmPopup) {
      this.fmPopup.onReopen(function () {
        _this2.setLine();
      });
    }
  },
  ...
  methods: {
    ...
    setLine: function setLine() {
      ...
      this.$nextTick(function () {
        ...
        var label = titles[_this4.currentIndex].$el;
        var lineWidth = _this4.lineWidth,
          lineHeight = _this4.lineHeight;
        var left = label.offsetLeft + label.offsetWidth / 2;
        var lineStyle = {
    ...
    setCurrentIndex: function setCurrentIndex(currentIndex) {
      ...
      if (newName !== this.active) {
        ...
        if (shouldEmitChange) {
          this.$emit('change', newName, newTab.label);
        }
      }
    },
    ...
    onClick: function onClick(item, index) {
      ...
      var _this$children$index = this.children[index],
        label = _this$children$index.label,
        disabled = _this$children$index.disabled,
        computedName = _this$children$index.computedName;
      if (disabled) {
        this.$emit('disabled', computedName, label);
      } else {
        ...
        this.$emit('tab-click', computedName, label);
    ...
    scrollIntoView: function scrollIntoView(immediate) {
      ...
      var label = titles[this.currentIndex].$el;
      var to = label.offsetLeft - (nav.offsetWidth - label.offsetWidth) / 2;

...
function createInstance() {
  ...
  if (!queue.length || multiple) {
    ...
    toast.$on('update:visible', function (visible) {
...
function Toast(options) {
  ...
  if (process.env.NODE_ENV === 'development' && options.mask) {
    console.warn('[Fawkes] Toast: "mask" option is deprecated, use "overlay" option instead.');
  }
...
['loading', 'success', 'warning', 'info', 'error'].forEach(function (method) {
...
Toast.allowMultiple = function (visible) {
  if (visible === void 0) {
    visible = true;
  }
  multiple = visible;

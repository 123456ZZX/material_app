...
var _default2 = (0, _utils.createComponent)({
  ...
  render: function render() {
    ...
    if (this.poppable) {
      ...
      return h(_popup.default, (0, _babelHelperVueJsxMergeProps.default)([{
        "attrs": (_attrs = {
          "round": true,
          "visible": this.value
        }, _attrs["round"] = this.round, _attrs["position"] = this.position, _attrs["showClose"] = this.showTitle || this.showSubtitle, _attrs["closeIconPosition"] = "top-right", _attrs["getContainer"] = this.getContainer, _attrs["closeOnPopstate"] = this.closeOnPopstate, _attrs["closeOnClickModal"] = this.closeOnClickModal, _attrs),

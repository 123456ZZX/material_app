...
var _default = createComponent({
  ...
  computed: {
    ...
    style1: function style1() {
      return {
        width: (0, _utils.addUnit)(this.size * 2 + 2),
        height: (0, _utils.addUnit)(this.size),
        backgroundColor: this.checked ? this.activeColor : this.inactiveColor
      };
    },
    style2: function style2() {
      return {
        width: (0, _utils.addUnit)(this.size),
        height: (0, _utils.addUnit)(this.size),
        transform: this.checked ? "translateX(" + (0, _utils.addUnit)(this.size + 2) + ")" : ''
      };
    }
  },
  methods: {

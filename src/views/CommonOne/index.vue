<template>
  <div class="main">
    <fm-nav-bar title="普通表单" left-arrow @click-left="$router.go(-1)"> </fm-nav-bar>
    <fm-search
      v-model="value"
...
import { getCommonFormList, deleteCommonForm } from './api'

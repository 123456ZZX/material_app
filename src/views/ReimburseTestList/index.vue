<template>
  <div class="main">
    <fm-nav-bar title="流程表单" left-arrow @click-left="$router.go(-1)"> </fm-nav-bar>
    <fm-search
      v-model="value"
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push({
        name: 'FormCenter',
        params: { type: 'add', formKey: 'reimburseTest' },
      })
    },
